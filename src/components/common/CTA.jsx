...
<div className='flex justify-center items-center p-1'>
          <Link
            to="/create-new-sheet"
            className="inline-flex items-center justify-center md:px-5 px-3 py-2 mr-3 md:text-base text-xs font-medium text-center text-white rounded-3xl bg-[#219B9D] hover:bg-[#A7E4CD] hover:text-black group focus:ring-2 focus:ring-green-300 transition-all duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg"
          >
            {btnText}
            <svg
