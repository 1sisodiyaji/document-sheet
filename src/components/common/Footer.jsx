  ...
  return (
    <>
      <footer className="bg-[#C2E9DB] rounded-lg shadow hidden md:block">
        ...
        <footer className="w-80 rounded-3xl md:hidden flex justify-around items-center bg-[#C2E9DB] z-[20] fixed bottom-1 py-2 border ring-2 ring-green-400">
         <Link to={'/'}><i className="fi fi-rs-home text-2xl"></i> </Link> 
         <Link to={'/create-new-sheet'} className='text-white bg-green-600 rounded-full w-10 h-10 p-2 overflow-y-hidden'> <i className="fi fi-rr-add text-2xl "></i> </Link>
